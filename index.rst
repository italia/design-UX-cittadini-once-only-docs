...
++++++++++++++++++++++++++++++++++++++
Progettare servizi per i cittadini abilitati dall’interoperabilità  
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

.. include:: /banner.rst

Questa documentazione raccoglie raccomandazioni per guidare le pubbliche amministrazioni nella progettazione di servizi abilitati dall’interoperabilità. 
...
Con il decreto-legge n. 19 del 19 febbraio 2026, il principio del once only viene reso operativo come integrazione al Codice dell'Amministrazione Digitale (CAD). In particolare, l'articolo 11 del decreto prevede che: 
...
La versione aggiornata (versione corrente) questa documentazione corrisponde alla **2026.1**. 
